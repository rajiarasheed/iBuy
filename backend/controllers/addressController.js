...
class AddressController extends BaseController{
    ...
    static createAddress=BaseController.asyncHandler(async(req,res)=>{
        ...
        const address=await AddressService.createAddress(req.user._id,validatedData);
        BaseController.logAction('ADDRESS_CREATED', address.user);
        BaseController.sendSuccess(res,'Address created successfully!',address,201)
    })
    // GET ALL ADDRESS
    static getAddresses=BaseController.asyncHandler(async(req,res)=>{
        ...
        BaseController.sendSuccess(res,'Address fetched successfully!',address,200)
    })
    // UPDATE ADDRESS
    static updateAddress=BaseController.asyncHandler(async(req,res)=>{
        ...
        BaseController.sendSuccess(res,'Address updated successfully!',address,200)
    })
    // DELETE ADDRESS
    static deleteAddress=BaseController.asyncHandler(async(req,res)=>{
        const address=await AddressService.deleteAddress(req.user._id,req.params.id);
